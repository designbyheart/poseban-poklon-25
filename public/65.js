...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    update: function update() {
      ...
      var requestParams = this.model; //Convert the expiration date of voucher
    ...
    "delete": function _delete() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_0___default.a["delete"](requestUrl).then(function (response) {
        if (response.data === 'success') {
          _this2.showNotification('success', 'request.deletedSuccess', 'success'); //Return to vouchers index page
    ...
    showSendPopup: function showSendPopup() {
      this.sendVoucherPopup.data.customer_email = this.model.order_item.order.customer_email;
...
/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/dashboard/views/voucher/Edit.vue?vue&type=template&id=6372a245&":
/*!********************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/dashboard/views/voucher/Edit.vue?vue&type=template&id=6372a245& ***!
  \********************************************************************************************************************************************************************************************************************/
...
var render = function() {
  ...
  return _c(
    "vx-card",
    { attrs: { title: _vm.getFormTitle(true), noShadow: "", cardBorder: "" } },
    [
      _c("div", { staticClass: "vx-row mb-6" }, [
        _c(
          "div",
          { staticClass: "vx-col w-50 flex" },
          [
            _c(
              "vs-button",
              {
                ...
                attrs: {
                  icon: "print",
                  size: "small",
                  href: _vm.API.voucher.print + "/" + _vm.model.id,
                  target: "_blank"
                }
              },
              [_vm._v(_vm._s(_vm.$t("actions.print")))]
            ),
            _vm._v(" "),
            _c(
              "vs-button",
              {
                staticClass: "mr-3",
                attrs: { icon: "send", size: "small" },
                on: { click: _vm.showSendPopup }
              },
        ...
        _c(
          "div",
          { staticClass: "vx-col w-50 flex justify-end" },
          [
            _c(
              "vs-button",
              {
                attrs: { color: "danger", icon: "delete", size: "small" },
                on: { click: _vm.showDeleteAlert }
              },
      ...
      _vm._v(" "),
      _c("div", { staticClass: "vx-row mb-6" }, [
        _c("div", { staticClass: "vx-col w-1/4 flex flex-column" }, [
          _c("p", { staticClass: "font-bold text-sm mb-2" }, [
            _vm._v(_vm._s(_vm.getPropertyTitle("voucherCode")))
          ]),
          _vm._v(" "),
          _c("div", { staticClass: "flex items-center flex-grow-1" }, [
            _c("p", [_vm._v(_vm._s(_vm.model.voucher_code))])
          ])
        ]),
        _vm._v(" "),
        _c("div", { staticClass: "vx-col w-1/4 flex flex-column" }, [
          _c("p", { staticClass: "font-bold text-sm mb-2" }, [
            _vm._v(_vm._s(_vm.getPropertyTitle("activationCode")))
          ]),
          _vm._v(" "),
          _c("div", { staticClass: "flex items-center flex-grow-1" }, [
            _c("p", [_vm._v(_vm._s(_vm.model.activation_code))])
          ])
        ]),
        _vm._v(" "),
        _c(
          "div",
          { staticClass: "vx-col w-1/4 flex flex-column" },
          [
            _c("p", { staticClass: "font-bold text-sm mb-2" }, [
              _vm._v(_vm._s(_vm.getPropertyTitle("endDate")))
            ]),
            _vm._v(" "),
            _c("datepicker", {
        ...
        _c("div", { staticClass: "vx-col w-1/4 flex flex-column" }, [
          _c("p", { staticClass: "font-bold text-sm mb-2" }, [
            _vm._v(_vm._s(_vm.getPropertyTitle("activated")))
          ]),
          _vm._v(" "),
          _c(
            "div",
            ...
            [
              _vm.model.activated
                ? _c("vs-icon", {
                    staticClass: "mr-3",
                    attrs: { icon: "check", color: "success", size: "small" }
                  })
                : _vm._e(),
              _vm._v(" "),
              !_vm.model.activated
                ? _c("vs-icon", {
                    staticClass: "mr-3",
                    attrs: { icon: "close", color: "danger", size: "small" }
                  })
                : _vm._e(),
              _vm._v(" "),
              !_vm.model.activated
                ? _c(
                    ...
                    {
                      attrs: { size: "small" },
                      on: { click: _vm.activateVoucher }
                    },
                    [_vm._v(_vm._s(_vm.$t("action.activate")))]
                  )
                : _vm._e()
            ],
            1
      ...
      _c("div", { staticClass: "vx-row mb-6" }, [
        _c(
          ...
          [
            _c("p", { staticClass: "font-bold text-sm mb-2" }, [
              _vm._v(_vm._s(_vm.getPropertyTitle("title")))
            ]),
            _vm._v(" "),
            _c("vs-input", {
              staticClass: "w-full",
            ...
            _c(
              ...
              [_vm._v(_vm._s(_vm.$t("messages.validation.invalidField")))]
            )
          ],
          1
        ),
        ...
        _c(
          ...
          [
            _c("p", { staticClass: "font-bold text-sm mb-2" }, [
              _vm._v(_vm._s(_vm.getPropertyTitle("description")))
            ]),
            _vm._v(" "),
            _c("vs-textarea", {
              model: {
        ...
        _c(
          ...
          [
            _c("p", { staticClass: "font-bold text-sm mb-2" }, [
              _vm._v(_vm._s(_vm.getPropertyTitle("personalMessage")))
            ]),
            _vm._v(" "),
            _c("vs-textarea", {
              model: {
        ...
        _c(
          ...
          [
            _c("p", { staticClass: "font-bold text-sm mb-2" }, [
              _vm._v(_vm._s(_vm.getPropertyTitle("location")))
            ]),
            _vm._v(" "),
            _c("vs-input", {
              staticClass: "w-full",
        ...
        _c(
          ...
          [
            _c("p", { staticClass: "font-bold text-sm mb-2" }, [
              _vm._v(_vm._s(_vm.getPropertyTitle("weather")))
            ]),
            _vm._v(" "),
            _c("vs-input", {
              staticClass: "w-full",
        ...
        _c(
          ...
          [
            _c("p", { staticClass: "font-bold text-sm mb-2" }, [
              _vm._v(_vm._s(_vm.getPropertyTitle("duration")))
            ]),
            _vm._v(" "),
            _c("vs-input", {
              staticClass: "w-full",
        ...
        _c(
          ...
          [
            _c("p", { staticClass: "font-bold text-sm mb-2" }, [
              _vm._v(_vm._s(_vm.getPropertyTitle("visitors")))
            ]),
            _vm._v(" "),
            _c("vs-input", {
              staticClass: "w-full",
        ...
        _c(
          ...
          [
            _c("p", { staticClass: "font-bold text-sm mb-2" }, [
              _vm._v(_vm._s(_vm.getPropertyTitle("dressCode")))
            ]),
            _vm._v(" "),
            _c("vs-input", {
              staticClass: "w-full",
        ...
        _c(
          ...
          [
            _c("p", { staticClass: "font-bold text-sm mb-2" }, [
              _vm._v(_vm._s(_vm.getPropertyTitle("additionalInformation")))
            ]),
            _vm._v(" "),
            _c("vs-input", {
              staticClass: "w-full",
      ...
      _c(
        ...
        [
          _c("div", { staticClass: "vx-row w-full px-0 mb-3" }, [
            _c(
              "div",
              { staticClass: "vx-col w-2/3" },
              [
                _c("p", { staticClass: "font-bold text-sm mb-2" }, [
                  _vm._v(_vm._s(_vm.getPropertyTitle("customerEmail")))
                ]),
                _vm._v(" "),
                _c("vs-input", {
                  staticClass: "w-full",
            ...
            _c(
              ...
              [
                _c("p", { staticClass: "font-bold text-sm mb-2" }, [
                  _vm._v(_vm._s(_vm.getPropertyTitle("paperSize")))
                ]),
                _vm._v(" "),
                _c(
                  "vs-select",
                  ...
                  _vm._l(_vm.sendVoucherPopup.paperOptions, function(
                    item,
                    index
                  ) {
          ...
          _vm._v(" "),
          _c("div", { staticClass: "vx-row w-full px-0" }, [
            _c(
              "div",
              { staticClass: "vx-col w-full" },
              [
                _c("vs-button", { on: { click: _vm.sendVoucher } }, [
                  _vm._v(_vm._s(_vm.$t("actions.send")))
                ])
              ],
              1
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _Edit_vue_vue_type_template_id_6372a245___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Edit.vue?vue&type=template&id=6372a245& */ "./resources/js/dashboard/views/voucher/Edit.vue?vue&type=template&id=6372a245&");
/* harmony import */ var _Edit_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./Edit.vue?vue&type=script&lang=js& */ "./resources/js/dashboard/views/voucher/Edit.vue?vue&type=script&lang=js&");
...
var component = Object(_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__["default"])(
  ...
  _Edit_vue_vue_type_template_id_6372a245___WEBPACK_IMPORTED_MODULE_0__["render"],
  _Edit_vue_vue_type_template_id_6372a245___WEBPACK_IMPORTED_MODULE_0__["staticRenderFns"],
  false,
  null,
  null,
  null
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_Edit_vue_vue_type_template_id_6372a245___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!../../../../../node_modules/vue-loader/lib??vue-loader-options!./Edit.vue?vue&type=template&id=6372a245& */ "./node_modules/vue-loader/lib/loaders/templateLoader.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/dashboard/views/voucher/Edit.vue?vue&type=template&id=6372a245&");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "render", function() { return _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_Edit_vue_vue_type_template_id_6372a245___WEBPACK_IMPORTED_MODULE_0__["render"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "staticRenderFns", function() { return _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_Edit_vue_vue_type_template_id_6372a245___WEBPACK_IMPORTED_MODULE_0__["staticRenderFns"]; });
