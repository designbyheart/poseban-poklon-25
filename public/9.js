...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    create: function create() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_0___default.a.post(this.API.attribute.create, requestParams).then(function (response) {
    ...
    update: function update() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_0___default.a.put(this.API.attribute.update + '/' + attribute_id, requestParams).then(function (response) {
        if (response.data === 'success') {
    ...
    getSingleAttribute: function getSingleAttribute() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_0___default.a.get(this.API.attribute.single, requestParams).then(function (response) {
