    ...
    <vx-card :title="getFormTitle(isEditForm)" noShadow cardBorder>
        ...
        <div class="vx-row">
            <div class="vx-col w-full">
                ...
                <vs-button color="danger" type="border" class="mb-2" :to="{ name: 'attributes' }">{{ $t('actions.cancel') }}</vs-button>
            </div>
        </div>
...
<script>
    ...
    import { model, validations, formStructure } from "@/static/attribute/attribute";
    ...
    export default {
        ...
        methods: {
            create(){
                ...
                axios.post(this.API.attribute.create, requestParams)
                    .then(
                        response => {
            ...
            update(){
                ...
                let attribute_id = this.$route.params.attributeId;

                axios.put(this.API.attribute.update + '/' + attribute_id, requestParams)
                    .then(
                        response => {
            ...
            getSingleAttribute(){
                ...
                axios.get(this.API.attribute.single, requestParams).then(response => {
