                        ...
                        <center>
                            <table cellpadding="0" cellspacing="0" width="600"
                                ...
                                <tr>
                                    ...
                                    <td width="508">
                                    <span style="font-family: Rubik; color: #ed2025; font-size: 20px;">Broj porudžbine {{ $order->id }} ( {{ $order->created_at }} )</span>
                                    </td>
                                    <td width="46" style="width: 46px; background: #ffffff;">
                                        <img src="https://posebanpoklon.rs/images/email/white_td.jpg">
                                    </td>
                                    ...
                                    <td width="508">
                                        <table cellpadding="0" cellspacing="0" width="600"
                                                ...
                                                <tr>
                                                    <td width="250" style="border: 1px solid #fdeaf0;">
                                                        <table cellpadding="0" cellspacing="0" width="250"
                                                            ...
                                                            <tr>
                                                                <td width="250"
                                                                    style="padding: 15px; font-family: Rubik; color: grey;">{{ $item->product->title }}</td>
                                                            </tr>
                                                        </table>
                                                    </td>
                                                    <td align="center" width="50"
                                                        style="padding: 15px; border: 1px solid #fdeaf0; text-align: center; font-family: Rubik; color: grey;">
                                                    ...
                                                    <tr>
                                                        <td width="250" style="border: 1px solid #fdeaf0;">
                                                            <table cellpadding="0" cellspacing="0" width="250"
                                                                ...
                                                                <tr>
                                                                    <td width="250"
                                                                        style="padding: 15px; font-family: Rubik; color: grey;">
                                                                        Poklon kutija
                                                                    </td>
                                                                </tr>
                                                            </table>
                                            ...
                                            <tr>
                                                ...
                                                <td width="50"
                                                    style="padding: 15px; border: 1px solid #fdeaf0; font-family: Rubik; color: grey;"></td>
                                                <td width="100"
                                                    style="padding: 15px; border: 1px solid #fdeaf0; font-family: Rubik; color: grey;">
                                    ...
                                    <tr>
                                        ...
                                        <td width="508">
                                            <table cellpadding="0" cellspacing="0" width="600"
                                                ...
                                                <tr>
                                                    <td width="500"
                                                        style="padding: 15px; border: 1px solid #fdeaf0; font-family: Rubik; color: grey;">{{ $order->comment }}</td>
                                                </tr>
                                            </table>
                                        </td>
                                        <td width="46" style="width: 46px; background: #ffffff;">
