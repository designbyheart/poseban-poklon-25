<center>
    ...
    @elseif ($order->status != null & $order->status->id === 2)
    <table cellpadding="0" cellspacing="0" width="600" style="width: 600px;">
        <tr>
            <td width="600">
                Ćao,
                <br><br>Tvoja uplata za porudžbinu br. {{ $order->id }} , upravo je „legla” na naš račun. Šaljemo najbrže što možemo (wink). Čim dobiješ naše obaveštenje, stiže i vaučer poslat na način koji si izabrao/la u porudžbini.
                <br><br>Detalji porudžbine:
            </td>
        </tr>
    </table>
    ...
    @elseif ($order->status != null & $order->status->id === 3)
    <table cellpadding="0" cellspacing="0" width="600" style="width: 600px;">
        <tr>
            <td width="600">
                Ćao,
                <br><br>Ako čitaš ovaj mejl, znači da smo uspešno poslali tvoj vaučer onako kako si to izabrao/la u porudžbenici.
                <br><br>Ukoliko je tvoj izbor bio e- vaučer, trebalo bi da se već nalazi u tvom e-sandučetu, ako ga nema, za svaki slučaj proveri spam folder, pre nego što nam javiš. 😉
                <br><br>Ukoliko si izabrao/la isporuku na kućnu adresu, to znači da smo poslali kurirskom službom „Post express”. Broj za praćenje možemo da pošaljemo u posebnom mejlu, a dostava deluje u najkraćem roku.
                <br><br>Detalji porudžbine:
            </td>
        </tr>
    </table>
    ...
    @elseif ($order->status != null & $order->status->id === 4)
    <table cellpadding="0" cellspacing="0" width="600" style="width: 600px;">
        <tr>
            <td width="600">
                Ćao,
                <br><br>Plaćanje neuspešno – račun Vaše platne kartice nije zadužen.
                <br><br>Detalji porudžbine:
            </td>
        </tr>
    </table>
            ...
            <td width="508">
                <table cellpadding="0" cellspacing="0" width="600"
                    ...
                    <tr>
                        ...
                        <td width="250"
                            style="padding: 15px; border: 1px solid #fdeaf0; font-family: Rubik, sans-serif; color: grey;">Turistička agencija Republika 031 <br>Svetozara Lazovića Gonga 4, 31000 Užice, Srbija</td>
                    </tr>
                    <tr>
                        <td width="250" style="padding: 15px; border: 1px solid #fdeaf0; font-family: Rubik, sans-serif;">
                        ...
                        <td width="250"
                            style="padding: 15px; border: 1px solid #fdeaf0; font-family: Rubik, sans-serif; color: grey;">160-6000002025893-02</td>
                    </tr>
                    <tr>
                        <td width="250" style="padding: 15px; border: 1px solid #fdeaf0; font-family: Rubik, sans-serif;">
                            Iznos
